...
namespace CFM
{
	...
	public:
		PEFSymbolResolver(Common::Allocator& allocator, FragmentManager& cfm, const std::string& filePath);
		PEFSymbolResolver(Common::Allocator& allocator, FragmentManager& cfm, Common::FileMapping&& mapping);
